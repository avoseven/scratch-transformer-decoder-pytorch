...
3. **Modelの性能変化**
    ...
    - 原因としては，**モデル容量が小さすぎるため，特定ドメイン（livedoorニュース）の分布を学習しようとすると，事前学習済みの汎用日本語分布が破壊される**ことが考えられる
    - 現時点では，**追加学習なしの事前学習済みモデルをそのまま利用するか，ごく軽い追加学習（学習率 1e-6〜5e-6，ステップ数 200〜500）に留める**ことを推奨
